...
from ...dtensors import tensor_to_dtensor, use_async_tensor_parallel
from ..dtensor_module import DTensorModule
from ..TP import get_parameter_placements, get_tensor_parallel_activation_placements
...
class ColumnParallelLinear(ParameterizedLinear, DTensorModule):
    def __init__(
        ...
        ParameterizedLinear.__init__(
            self, in_features=in_features, out_features=self.out_features_per_tp_rank, bias=bias, std=std
        )
