...
def test_megatron_dataset_builder() -> None:
    with tempfile.TemporaryDirectory() as tmpdir:
        ...
        _build_dataset(bin_path, idx_path, num_documents, document)
...
def test_megatron_dataset_merge() -> None:
    with tempfile.TemporaryDirectory() as tmpdir:
        ...
        _build_dataset(bin_path1, idx_path1, num_documents1, document1)
        ...
        _build_dataset(bin_path2, idx_path2, num_documents2, document2)
